...
class NetworkUtils {
    ...
    static URL buildUrl(String endpoint, Integer id) {
        return buildUrl(endpoint.replace("{id}", id.toString()));
    }
    ...
    static String buildMovieTrailerPath(String movieTrailerKey) {
        return BASE_TRAILER_URL + movieTrailerKey;
    }
